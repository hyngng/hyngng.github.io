...
在社会服务期间，办公室里遇到了一个问题。[社会服务人员工作后记文章](https://hyngng.github.io/zh/essay/sabok-logs/)中有更详细的整理，简单概括就是公共机构不能随意使用未经许可的外部程序，这个经历成为了程序开发的动机。不过，我并不是仅仅出于"直接自己做一个来用"的想法开始的。因为想在不同的语境下使用通过 Unity 初次接触的 C#，也想认真做一次 Windows 程序，所以才大胆开启了新项目。
