...
While developing the [automated stock trading program](https://hyngng.github.io/en/dev/astp-devlog/), I encountered a situation where the program couldn't run in a 64-bit environment. As an alternative, I looked into setting up a 32-bit virtual environment. Most sources recommended Anaconda, but that seemed cumbersome. After searching for alternatives, I found a way to open a 32-bit virtual environment in VS Code. Following the steps was not difficult, so I've briefly documented the method here.
