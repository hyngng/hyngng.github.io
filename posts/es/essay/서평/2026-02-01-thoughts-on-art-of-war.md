...
|Subtítulo|Todas las estrategias y tácticas del mundo|
|Autor|Sun Tzu (original), compilado y escrito por Lim Yong-han|
|Editorial|Kyobo Book Centre|
|Fecha de 1.ª edición|28 de enero de 2025|
...
Las citas son abundantes, por lo que el proceso de llegar a una conclusión es variado en cada caso, y seguir ese flujo fue entretenido en sí mismo. Por ejemplo, en el capítulo de la Forma (形), se presenta el texto original de los bambúes de la dinastía Han descubiertos en 1972: «守則有餘, 攻則不足 (defender es tener de sobra; atacar es tener insuficiencia)», y se señala que esta frase, debido a la dificultad de su interpretación, fue transformada posteriormente en «守則不足, 攻則有餘 (cuando las fuerzas son insuficientes, defender; cuando las fuerzas son suficientes, atacar)». Incluso en la primera edición comentada de *El Arte de la Guerra* por Cao Cao se registra de esta última forma, pero se introduce la anécdota de que el emperador Tang Taizong, Li Shimin, y su estratega militar Li Jing, encontraron extraña esa edición comentada, no la aceptaron y crearon otra interpretación, convenciendo al lector de la rareza semántica de la popular «守則不足, 攻則有餘», para dar inicio al tema principal.
...
*El Arte de la Guerra. La calidad del libro era impresionante.*
