...
いくつかのアイデアを考えてみると、五W一HベースのPythonライブラリ、ミラーレス風カメラアプリケーション、2Dモバイルゲームなどがありました。それぞれ[Pythonベースのプログラム](https://hyngng.github.io/ja/dev/astp-devlog/)やAndroid Studioでの簡単なアプリケーション作成経験、または[以前のUnityプロジェクト](https://hyngng.github.io/ja/dev/lavad-devlog/)から派生したものでした。
