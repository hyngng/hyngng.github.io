...
[直前のプロジェクトの経験](https://hyngng.github.io/posts/armonia-devlog-cancelled/)から学んだことの一つは、何かを長期間かけて開発することは、一方で自分が何か大きな文脈に関与されるということです。間違えると開発する過程が疲れて苦痛な経験として残る可能性もあるため、テーマを熟考して慎重に決める必要があります。
