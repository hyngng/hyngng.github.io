...
미루고 미뤄왔던 숙원 중 하나입니다. 2024년 SEO 개선을 목표로 테마를 뜯어보기 시작했고, 태그와 기능을 추가하고 몇 달간 운용해본 다음 그 효용에 따라 기능을 소거해보기도 하면서 SSG 블로그 이해가 쌓여갔습니다. 그렇게 관리기간이 4년 지나면서 이건 결국 정적 웹 프레임워크이고, 쉽게 요약해서 정교한 for문으로 이루어진 웹페이지 생성기인 것으로 인상이 단순해졌습니다. 웅장한 건물을 처음 보는 듯 경외스러웠던 첫인상이 무너지면서, 이 정도면 고유 공간을 직접 설계해보고 싶다는 생각이 들었습니다.
