...
생각해볼 수 있는 대안은 SEL2860, SEL35F28Z, SEL40F25G를 포함한 단렌즈 트리오, 그리고 빌트록스 AF 50mm F2 에어나 티티아티산 AF 40mm F2, 삼양 리마스터 슬림 시리즈 등 정도가 있습니다. 하지만 하나같이 수광량이나 비네팅, 보케 품질 등 타협이 적잖이 요구되는 문제가 있습니다. 이런 딜레마가 발생하는 것은 근본적으로 큰 센서에는 큰 렌즈가 적합하기 때문입니다.
...
- AF가 확실히 답답합니다. 후지필름 카메라가 5세대까지 오면서 쓸만한 정도로 개선됐다는 평가가 많이 보이지만, 그 쓸만함이라는 것은 정말 오래 전부터 카메라를 사용해온 분들의 주관적인 평인 것으로 보입니다. 제 개인적으로는 보급형 스마트폰보다도 부족한 인상을 받았습니다.
:::
