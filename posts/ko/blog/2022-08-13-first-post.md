...
깃허브 블로그를 개설했습니다! 원래는 티스토리나 Velog도 고려해보다가 블로그 테마 코드를 직접 세세하게 수정할 수 있다는 점에 흥미가 생겨 깃허브 블로그를 선택했습니다. 도중에 `layout: home # index page` 오류나 `gh-pages` 브랜치 누락, `pages-deploy.yml` 파일 내역 오류 등 생각보다 난관이 많아 당황했는데 끝내 블로그 페이지가 잘 나오는 모습을 보니 뿌듯합니다.

<!--
블로그 테마는 고민없이 [Chirpy 테마](https://github.com/cotes2020/jekyll-theme-chirpy/)를 선택했습니다. 깔끔하고 단정하면서도 다크모드 등 편의기능도 많이 들어있더라구요.
-->
