...
깃허브 블로그 홈에 대한 내역은 `_layouts/home.html`에 작성되어 있습니다. 순정 코드는 저의 경우 위와 같이 작성되어 있었으며, `<div class="card-text content mt-0 mb-3">` 단락에서 포스트 요약본을 생성하고 있습니다.
...
Chirpy 버전이 `v7.4.0`으로 업데이트되면서 `post-description.html`이 `post-summary.html`로 대체되었습니다. 다만 구조는 거의 비슷하기 때문에, 다음과 같이 작성할 수 있습니다.
