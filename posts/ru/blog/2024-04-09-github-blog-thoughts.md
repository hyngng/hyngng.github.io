...
Прошло почти 2 года с тех пор, как я [открыл блог](https://hyngng.github.io/posts/first-post/). Честно говоря, за два года я написал не так много, но это не значит, что я был к нему равнодушен. Бывали занятые периоды — и личные, и рабочие, бывали периоды затишья, но я всё равно периодически поддерживал блог.
...
В моём случае я уже написал две статьи о [разнообразных настройках](https://hyngng.github.io/posts/first-blog-customization/) и [реализации определённых функций](https://hyngng.github.io/posts/blog-content-remove/). Хотя отдельно я об этом не писал, недавно я также добавил LQIP-превью, иконку Instagram, кнопку аплодисментов и некоторые другие фишки.
