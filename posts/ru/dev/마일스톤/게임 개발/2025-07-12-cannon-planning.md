...
Один из уроков, извлечённых из [опыта предыдущего проекта](https://hyngng.github.io/ru/dev/armonia-devlog-cancelled/), заключается в том, что долгосрочная разработка, с одной стороны, вовлекает вас в некий масштабный контекст. Если неосторожно, процесс разработки может стать утомительным и мучительным опытом, поэтому тему нужно выбирать, тщательно всё обдумав.
