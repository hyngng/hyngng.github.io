...
Среди идей были: библиотека на Python на основе шести вопросов журналистики, камера-приложение в стиле беззеркалок, 2D-мобильная игра. Каждая из них была ответвлением от предыдущего опыта — [Python-программы](https://hyngng.github.io/ru/dev/astp-devlog/), простого приложения на Android Studio или [предыдущего проекта на Unity](https://hyngng.github.io/ru/dev/lavad-devlog/).
