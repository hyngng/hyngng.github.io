...
- Кроме того, из-за того, что модуль с общим сертификатом не поддерживает 64-битную среду, необходимо [вручную создать 32-битную виртуальную среду](https://hyngng.github.io/ru/dev/virtual-32bit/) и запускать код в ней, даже если это неудобно.
