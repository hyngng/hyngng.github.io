...
last_modified_at: 2025-09-29 21:29:00 +0900
...
그럼에도 원래는 블로그 분위기가 너무 딱딱해질까봐 기술적 개념을 다루는 포스트는 일부로 자세히 작성하지 않으려 했는데, 최근 블로그의 어원이 Web + Log라는 것을 알게 되고 공부한 것을 정리한 글고 나름 괜찮겠다는 생각이 들었습니다. 그래서 앞으로 따로 기록이 필요한 것들은 아예 한 번씩 심도있게 짚고 넘어갈 겸 블로그에 차근차근 하나씩 정리해두려고 합니다.
