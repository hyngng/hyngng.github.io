...
last_modified_at: 2026-06-02 13:49:00 +0900
...
내가 어디쯤 와있는지는 모호하다. 앎의 4단계로 비유하면 의식적 유능 정도의 단계이지 않을까 싶고, 무엇이 좋은 설계인지 조망할 감은 없는 것 같다. 그런 와중에 조금씩 알 것 같은, 재밌는 생각이 드는 것들이 몇 가지씩 생기고 있다.
...
하나. 무언가를 책임진 사업가, 야망가는 불확실성을 싫어한다. 국경을 접한 북방 제국이 한반도계 국가를 끊임없이 침략한 이유 중 하나는 대륙 정벌이라는 사업을 달성하기 이전에 후방을 안정시키기 위해서였다. 로마는 카르타고를 치기 전에 이탈리아 반도를 먼저 통일했고, 독일은 프랑스 침공 이전에 소련과 불가침조약을 체결했다. 사례도 동기는 크게 다르지 않다. 사업의 규모가 클수록, 책임자의 집착이 진지할수록 블랙스완 차단은 필수적이다.
