...
last_modified_at: 2026-04-18 13:24:00 +0900
...
이 경험에서 사후적으로 짚고 넘어갈 부분이 하나 있습니다. 찾아본 바에 의하면 마이크로소프트는 지난 20여 년간 WinForms를 시작으로 WPF, UWP, WinUI 3, 그리고 최근의 MAUI에 이르기까지 구 플랫폼과 완벽히 호환되지 않는 새 프레임워크를 잔뜩 쏟아냈고, 개발자 입장에서 무엇을 표준으로 잡고 개발해야 하는지 정답이 사실상 없게 만들었습니다. 윈도우 프로그램 개발 프레임워크는 게임이나 모바일, 웹 개발과 달리 선택 기준이 모호한 것이 사실이고, 제 삽질은 2026년 윈도우 프로그램 개발을 처음 시도하는 입장에서 조금은 통과의례였던 것 같습니다.
