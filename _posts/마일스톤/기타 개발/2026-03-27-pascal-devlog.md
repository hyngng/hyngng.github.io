...
몇 년 전, 어느 해외 작가가 작품에 온전히 집중하기 위해 직장을 그만두려 한다는 글을 본 적이 있습니다. 그리고 한 독자가 댓글로 "네가 하고 싶은 일 때문이라고 해도 어떤 이유로든 직장을 그만두는 건 좋지 않다고 생각한다"라고 조언하자, 이 작가는 "마음에 들지도 않는 직장 사무실에서 내 상상력이 죽게 내버려둔 것을 이미 후회하고 있다"라는 취지의 강력한 한 마디를 달았고 논쟁은 그 지점에서 끝났습니다.

이 일화가 프로그램 개발 도중 한 번 생각났습니다. 예술작품을 만들 때 들기 마련의, 정신적 감응, 자아실현의 절박함, 이런 것들이 프로그램 개발에 필요한 것은 아니므로 엄밀히는 저와 상황이 다릅니다. 하지만 소모적인 업무가 매일 발생하는 곳이 창작과 작업 추진 의지를 얼마나 지치게 만드는지에 대해서는 공감되는 부분이 있었습니다.
