...
last_modified_at: 2026-06-10 11:23:00 +0900
...
하지만 막상 깃허브 외에는 기대한 만큼의 호응이 없었고, 사실 조금 머쓱했습니다. 동료가 게을러서는 아니었고, WinUI 3라는 새 환경도 벅찬데 노션, 피그마라는 도구가 왜 필요한지 설득력이 잘 없었던 것 같습니다. 저는 자원 관리 체계가 개발을 더 멀리 지속시킬 수 있으므로 언제나 필요하다고 생각했던 반면, 동료분께서는 개발과 크게 상관없는 비용이라면 필요에 따라 내칠 수 있다고 보셨던 것 같습니다. 그리고, 차차 여기서는 그 관점이 맞다는 생각이 들었습니다. 객체지향의 효용성과 마찬가지로 좋은 도구와 좋은 패턴에도 그것이 정당화되는 규모가 있다는 것을 느꼈습니다. 좋은게 좋은 것이라며 도구를 관성적으로 맹신했던 것 같습니다.
...
몇 년 전, 어느 해외 작가가 작품에 온전히 집중하기 위해 직장을 그만두려 한다는 글을 본 적이 있습니다. 그리고 한 독자가 댓글로 "네가 하고 싶은 일 때문이라고 해도 어떤 이유로든 직장을 그만두는 건 좋지 않다고 생각한다"라고 조언하자, 이 작가는 "마음에 들지도 않는 직장 사무실에서 내 상상력이 죽게 내버려둔 것을 이미 후회하고 있다"라는 취지로 강력한 한 마디를 달았고 그 지점에서 논쟁이 끝났습니다.

이 일화가 프로그램 개발 도중 한 번 생각났습니다. 예술작품을 만들 때 들기 마련의, 정신적 감응, 자아실현의 절박함, 이런 것들이 프로그램 개발에 필요한 것은 아니므로 엄밀히는 저와 상황이 다릅니다. 하지만 소모적인 업무를 매일 처리해야 하는 환경이 창작과 작업 추진 의지를 얼마나 지치게 만드는지에 대해서는 공감되는 부분이 있었습니다.
