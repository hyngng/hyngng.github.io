...
이 일화가 프로그램을 개발하면서 종종 생각났습니다. 예술작품을 만들 때 들기 마련의, 정신적 감응, 자아실현의 절박함, 이런 것들이 프로그램 개발에 필요한 것은 아니므로 엄밀히는 저와 상황이 다릅니다. 하지만 사람을 지치게 만드는 소모적인 업무가 매일 발생하는 곳에서 남몰래 시선을 미래에 두고 시간을 투자하려는 것 자체는 저도 공감할 부분이 있었습니다.
