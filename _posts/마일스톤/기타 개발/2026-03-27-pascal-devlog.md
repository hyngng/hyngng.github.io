...
몇 년 전, 어느 해외 작가가 작품에 온전히 집중하기 위해 직장을 그만두려 한다는 글을 올린 것을 봤습니다. 그리고 한 독자가 "네가 하고 싶은 일 때문이라고 해도 어떤 이유로든 직장을 그만두는 건 좋지 않다고 생각한다"라고 조언하자, 이 작가는 "마음에 들지도 않는 직장 사무실에서 내 상상력이 죽게 내버려둔 것을 이미 후회하고 있다"라는 취지의 강력한 한 마디를 달았고 논쟁은 그 지점에서 끝났습니다.
...
실제로 이 프로젝트는 진척이 힘들었습니다. 어떤 UI 컨트롤을 어떻게 사용할 수 있을지 상상하고 있을 때 업무 관련해서 불려나가고, 20분 후 자리에 돌아와서 맥락을 다시 짚다보면 자리 전화벨이 울렸습니다. 창의력이 필요한 순간 뿐만 아니라, M-V-VM간 의존성 흐름을 검토하는 등의 단순 디버깅 작업도 잦은 방해로 집중이 어려웠습니다. 부당한 상황이었다며 마냥 투덜거리고 싶은건 아닙니다. 다만 환경적 여유가 없을 때 일 능률이 어디까지 떨어질 수 있는지를 이번에 확인할 수 있었습니다.
