...
사회복무 도중 사무실에서 문제가 있었습니다. [사회복무요원 근무 후기 글](https://hyngng.github.io/posts/sabok-logs/)에 더 자세히 정리되어 있지만, 간단히 요약하면 공공기관은 라이선스 허가받지 않은 외부 프로그램을 함부로 사용할 수 없다는 점을 지적받은 적 있었고, 그 경험이 프로그램 개발 동기로 이어졌습니다. 다만 단순히 '직접 만들어 쓰자'는 생각만으로 시작한 것은 아닙니다. 유니티로 먼저 접한 C#을 다른 맥락에서도 써보고 싶었고, 제대로 된 윈도우 프로그램도 한 번 다루어보고 싶었던 찰나였던 덕분에 새 프로젝트를 과감히 열 수 있었습니다.
...
개발에 있어 실제로 잦은 방해를 받았고 진척이 꽤 어려웠습니다. 단순한 디버깅 작업도 M-V-VM간 의존성 흐름을 거슬러 올라가보고 있을 때 업무 관련해서 불려나가고, 20분 후 자리에 돌아와서 맥락을 다시 짚다보면 자리 전화벨이 울리는 환경이었습니다. 이 부분은 부당했다며 투덜거리고 싶은건 아닙니다. 다만 환경이 따라주지 못할 때 일 능률이 어디까지 떨어질 수 있는지를 보았습니다.
