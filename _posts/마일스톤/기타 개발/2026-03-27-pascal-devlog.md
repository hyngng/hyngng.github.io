...
실제로 이 프로젝트는 진척이 힘들었습니다. 어떤 UI 컨트롤을 어떻게 사용할 수 있을지 상상하고 있을 때 업무 관련해서 불려나가고, 20분 후 자리에 돌아와서 맥락을 다시 짚다보면 자리 전화벨이 울렸습니다. 창의력이 필요한 순간 뿐만 아니라, M-V-VM간 의존성 흐름을 검토하는 등의 단순 디버깅 작업도 잦은 방해로 집중이 어려웠습니다. 부당한 상황이었다고 투덜거리고 싶은건 아닙니다. 다만 환경적 여유가 없을 때 일 능률이 어디까지 떨어질 수 있는지를 이번에 확인할 수 있었습니다.
