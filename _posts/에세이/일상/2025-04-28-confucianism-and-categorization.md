...
결론적으로, 사상이나 이념은 근본적으로 명분론이기 이전에 실용주의적 해결책이다. 따라서 현재의 최선책이라고 해서 맹목적으로 받아들이기보다는 과감히 변형할 수 있어야 한다. 앞선 유교적 잔재는 이미 우리 일상에 깊숙히 스며들어 하나의 사회문화 현상으로서 자리잡았지만, 사실은 필요한 경우 충분히 내쳐질 수 있다.
