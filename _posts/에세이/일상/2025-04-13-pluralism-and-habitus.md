...
나는 이 충돌을 이렇게 정리하고 싶다. 성질과 환경은 분리되어 있다. 어떤 성질이 필요한지는 환경이 정하는 것이고, 환경이 변하는 정도에 따라 전혀 다른 성질이 필요할 수 있다. 어떤 성질이 가치있는가는 각자의 인위적인 판단이다. 즉, 어떤 그림이 좋은 그림이라는 가치판단 기준은 개개인 또는 집단이 겪은 맥락에서 발생한 것이며, 이 관점에서 다원주의는 여전히 유효하다.
