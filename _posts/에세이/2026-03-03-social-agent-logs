...
실제로 어떻게 사회복무요원이 되는지 먼저 설명할 필요가 있을 것 같습니다. 11월 중반의 수능 철, 사회복무요원 신청도 재학생에 한해 [병무청 병무민원 사이트에서](https://mwpt.mma.go.kr/caisBMHS/) 약 일주일간 같이 이루어집니다. 기관이 병무청에 인원 충원을 희망한 건에 대해 사회복무 대상자는 소집을 최대 2개 기관까지 순차적으로 지원할 수 있습니다. 만약 정원보다 지원자가 많을 경우 무작위 추첨을 통해 선발하되, 1년에 한 번뿐인 기회인 만큼 탈락 횟수에 따라 우선순위를 차등 부여합니다.
...
![Frame 15](/2026-03-03-social-agent-logs/Frame 15.png){: .light .border }
![Frame 15](/2026-03-03-social-agent-logs/Frame 15.png){: .dark }
...
- 3월에는 사회복무요원을 이제 그만하고 싶다는 생각이 들었음.
...
쉽게 번역하면 "계약서에서 합의된 내용만을 이행하라"라는 이야기입니다. 그리고 이 원칙을 준수해야 하는 이유는 조직의 건전성을 위해서입니다. 그러니까, 사실 사회복무요원의 입장에서 진지하게 고민할만한 내용은 아닙니다.
...
마지막으로, 국제정치 이론이 실제로 효과를 보는지 확인하고 싶었습니다. 패권국이 교체되면 국제질서가 교체된다고 설명합니다. 설득력이 있는 이야기였고 역사상의 실례도 많았지만, 이것이 국소적으로 우리 사회에 적용할 수 있는 이야기인지 궁금했습니다. 그래서 제 생각에는, 실제로 효과가 있는 것 같습니다.
