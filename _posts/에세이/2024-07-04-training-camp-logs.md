...
보충역 자체의 현역대비 헐렁한 교육과정과 분위기도 있었습니다. 훈련소 생활에 따라 자대가 달라지는 현역과 달리 보충역은 수료 이후의 계획이 다 정해진 채로 입영을 해서 그런 것 같기도 합니다. 모두가 다 그렇지는 않겠지만 제 생활관에서는 장기대기로 전시근로역 편입을 앞두고 훈련소가 재밌다고 들어서 일부러 왔다는 특이한 경우도 있었습니다.
