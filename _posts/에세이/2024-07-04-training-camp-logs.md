...
2열로 정리가 끝나면 연무관 앞에서 생활관별로 건물 외곽에 캐리어를 정리해두고, 수료식 사열대를 맞춘 뒤 건물 복도로 들어가 9시 50분가지 잠시 대기시간을 가졌습니다. 시간이 되면 울려퍼지는 베이스와 킥에 왼발을 맞추며 안으로 입장하고, 전날 연습대로 제식을 맞추고 애국가, 육군훈련소가를 제창하고 나면 수료식도 끝납니다. 개인적으로는 살짝, 애국가를 부를 때 울컥한 마음이 있었습니다.
