...
last_modified_at: 2024-01-08 13:20:00 +0900
---
...
저는 이 지점이 가장 큰 고민이 되었습니다. 제대로 된, 특히 풀프레임 카메라는 그 크기 때문에 접근성이 떨어져 일상용으로 사용하기에는 부담이 있으므로 차라리 소니 카메라를 사용할 거라면 차라리 소니 엑스페리아를 직구하는 것이 더 나은 대안이지 않을까? 하는 생각이었죠. 최근 유행하는 후지 X100VI나 리코 GR3 등을 보면 소니 A7C는 아무리 작다 한들 여전히 크고 무거운 카메라 쪽인 것 같다는 생각이 그런 의심을 더 키웠습니다.
