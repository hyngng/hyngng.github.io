...
인물과 서사의 세심함과 적당한 진중함에 집중한 것도 좋았다. 후지노가 "만화 엄청 재미있었어"라는 말에 기세등등해지는 것, "이제 그만 그릴 때도 되지 않았냐"라는 말에 분한 감정을 느끼는 것. 특히 쿄모토의 "당신은 만화 천재에요"라는 말에 내심 우쭐해진 채 과장된 동작으로 비 내리는 길을 첨벙첨벙 밞으며 집으로 향하는 후지노의 감정표현은 솔직하다못해 입체적이었다.
...
어찌됐건. 룩백은 단편 영화로서 또래에 대한 경쟁심리, 동반자이자 경쟁자인 동료, 갑작스럽게 찾아오는 인생의 분기점과 변질된 초심, 쓸쓸함 등을 잘 담아낸 영화다. 90분의 짧은 분량에도 불구하고 포착할 것이 많은 정성스런 작품이었고, 영화를 보는 잠시나마 인생을 환기할 수 있어서 좋았다.