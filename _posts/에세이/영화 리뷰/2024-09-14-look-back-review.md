...
다만 결말은 조금 욕심내자면 아쉬웠다. 갑작스럽게 등장하는 쿄모토가 죽지 않은 평행세계와의 소통은 구체화되지 않은 메타포로 룩백을 결국 단편으로서, 진지하게 대할 수 없는 이유다. 물론, "그냥 이런 이야기도 있습니다"에 주안점을 두는 가벼운 단편으로서는 문제되지 않긴 하지만 말이다.  
