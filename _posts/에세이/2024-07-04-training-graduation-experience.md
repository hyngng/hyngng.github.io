...
일지를 쓰기 전에 매일매일 반복되는 내용을 먼저 정리했습니다. 먼저, 훈련소의 하루일과는 다음과 같이 진행됩니다.
...
생활관에서 대기하고 있다 보면 부식이 나옵니다. 훈련소에서는 매일 과자나 음료 등 부식을 주는데, 사회 생각이 나지 않도록 하는 일종의 진정제 역할을 했습니다. 
...
또, 분대장과 부분대장을 뽑았습니다. 부분대장은 존재감도 없는 형식상의 역할이지만 분대장은 나중에 고생을 하게 되기 때문에 눈치싸움이 시작될 줄 알았는데, 제 생활관에는 분대장 훈련병으로 뽑히면 먹을거리나 담배타임 등 혜택을 받을 수 있다며 자원한 사람이 한 명 있어서 금방 정해졌습니다.

점심 이후에는 다른 교육대 건물 무기고에서 본인 교번에 해당하는 총기를 받았습니다. 그 유명한 K2 소총을 실물로 처음 보게 되는 순간입니다. 실총은 무겁다고 들었는데 딱 제 기대만큼 무거웠고, 의외였던 점은 핸드가드와 개머리판쪽에 스크래치와 찍힘 자국이 굉장히 많았던 것이 기억납니다.
...
당시 메모 원본
: - 29살 161번 훈련병이 취침시간에 당직책상에서 "오늘도 수고했습니다"와 같은 멘트를 하러 불려갔고, 이 날부터 라디오병이라고 불리기 시작함
- 웃겼던거: "아 더 힘들게 하면 콜라 다 훔쳐버릴거야", "콜라 2개 주시면 문제 푼거 보여드릴게요", "군대가면 변비걸린댔는데 나는 똥이 줄줄나오네"
- 짬 시간에 할 게 없다며 책상에서 물병 뚜껑으로 당구랑 알까기 하는 사람도 있었음
...
이 날 부식이 나오기는 했는데, 구체적인 메모로 남기지는 않았습니다.

당시 메모 원본
: - 기본교재 검사때 내 글씨가 좋다며 다른 훈련병들이 분대장한테 보여줌. "야 글씨 좋네~"라며 칭찬받음. 이때부터 대필병으로 불림
- 예방접종 받을 인원조사가 있었음. 생활관 약사 박사과정 전문연구요원에게 접종받으면 좋냐고 하니까 여러가지로 좋다고 해서 "그럼 우리는 다 맞으러 가자~"라는 식이 됨

#### **5일차**

건강검진과 훈련 준비를 받는 날이었습니다.

아침점호 후에 뜀걸음이 있었는데, 이 날 아침점호 전에 전투화에 미리 가져간 다이소 깔창을 넣어서 사용해봤더니 착화감이 비교도 안 되게 굉장히 푹신해져서 놀랐던 것이 기억납니다. 뜀걸음이 끝나고 생활관에서 리하이 믹스라는 가루형 수분보충제를 지급받아서 호기심에 바로 타먹어봤더니 생활관 인원 전체의 솔직한 후기로 별로 맛이 없었습니다. 석류맛이라고는 하는데 그보다는 좀 애매한 맛이 났습니다.
...
당시 메모 원본
: - 점심식사 가다가 옛 분대장 훈련병이 분대장에게 걸려서 제식훈련 받고 감. "훈련병들, 제식이 장난이야? 놀러왔어? 이 훈련병 될 때까지 한다. 제자리걸어, 갓! 하나! 둘! 셋! 넷! ..." 웃긴게, 제식훈련이 계속되니까 이 훈련병이 "저 박치입니다"라고 고백했는데 분대장이 "저 빡칩니다"로 잘못 들어서 더 힘들어질뻔 함.
...
이 날의 메모 몇 가지
: - 전날 집 가고 싶다는 동기는 한숨 자고 진정함
- 전날 밥먹으러 가면서 제식 걸린것 때문에 제식 빡세게 맞췄더니 상점 받았음
- 이빨 신경치료 차 지구병원 갔다온 동기가 말하길, PX쪽에서 같이 간 키 큰 친구가 도중에 도망갔다가 20분만에 분대장에게 잡혀 돌아왔다고 함
 - 다른 훈련병 편지 대필 해줌
...
- 전에 집에 가고 싶다던 훈련병이 소대장한테 집에 가고 싶다고 말하니까 '바보야 갈꺼면 빨리 가야돼 사격만 하고 갈까? 하다가 수류탄도 던져보고 갈까? 하게 되고 그런 식으로 가다보면 벌써 2주차, 3주차 돼' 이러고 감
- 물 보급이 계속 나옴. 음식도 1.2~1.5인분으로 계속 준비하는 느낌
- 훈련소 입소 첫날 약지 까진거 거의 나음
- 사격자세 교육 때 탄창결합 처음 해봄
- 밥먹으러 갈 때 계속 제식 걸렸음
- 밤에 잘때 진짜 추움
...
3. 입장 후에도 본인 순서가 올 때까지 앞사람 동작을 지켜보면서 대기하다가, 본인 순서가 다가오면 컨트롤 타워의 지시를 큰 복명복창과 함께 따릅니다.
...
겨우 25m이긴 하지만 저는 밀덕끼가 있어서인지 처음치고 굉장히 잘 쐈습니다. 첫 사격 이후 두근거리는 마음으로 표적지를 확인하러 갔을 때 총알이 지나간 구멍이 정말 오밀조밀하게 모여있어서 놀랐습니다. 분대장이 "오~... 훈련병 잘 쏘는데? 크리크는 우로 3, 아래로 7 조정해. 훈련병은 잘 쏘니까 호흡만 신경써요"라고, 그리고 그 말을 듣던 전문부사수 훈련병이 "원래 저런 소리 잘 안 하시는데 진짜 잘 쏘셨나 봅니다"라고 말했던 것이 기억납니다. 별 소리 아니지만 그 날은 기분이 좋았습니다.

그래서인지 저는 3발 중 2발이 표적지 원 안에 명중해 사격은 한 번에 통과했습니다. 1차 합격자 비율은 1/3 정도였고, 다른 동기들중 몇몇분은 2차, 3차, 4차 사격에 가서도 불합격을 받아 36발가량 쏘는 동기도 있었습니다. 한 번의 사격 과정이 오래 걸리기 때문에 대기하면서 아침식사가 끝나고 같이 합격한 동기와 훈련이 끝나길 기다리면서 도란도란 이야기를 많이 나눴습니다. 4차 사격이 지나면 시간관계상 때문인지 더 이상 재사격 훈련은 이루어지지 않고 교육대로 복귀해 불합격한 사람만 따로 불러내 보충교육을 진행하는 식으로 교육을 대신합니다.

생활관으로 복귀하는 길에는 오아시스라고 다기능 작전모 안에 열 식히는 용도로 얼음을 3~4개 넣어서 이동합니다. 걷다보면 얼음이 녹으면서 물이 줄을 타고 내려오면서 모자 뒤에서 물방울 뚝 뚝 떨어지기 시작하는데, 이 물조차 말라가기 시작할때 쯤 육교를 넘어가게 되면 얼음을 다시 모자 안에 넣어서 이동하다보면 교육대로 복귀하게 됩니다. 돌아와서 생활관으로 복귀하기 전 연병장에서 "이 날 공격군장 무게는 총기를 합해서 5.8kg였다. 힘든 사람도 있었을 텐데 수고했다."라는 소대장님의 말씀을 듣고 생활관으로 복귀했습니다.

이 날 부식은 육포 느낌의 건조소시지와 눈을감자, 밀키스 500ml 캔이었습니다.

생활관에서 저녁에 쓰레기 버릴 때 상자를 급하게 잘못 뜯다가 왼손 엄지손가락 살짝 들리는 사고가 있었습니다.

이 날의 메모 몇 가지
: - 쓰레기 버릴 때 상자 잘못 뜯다가 손톱 들림
...
이후에는 TV시청이 허용이 되었는데, TV는 한 대고 사람은 많다 보니 의견을 수렴하던 도중에 어떤 동기의 "비 오는 날에 올드보이 보면 딱인데"라는 말이 있었고 호응이 좋아서 진짜로 올드보이를 보면서 시간을 보냈습니다.
...
|식판|식판을 설거지합니다|
|국그릇|국그릇을 설거지합니다|
|멀티|특별한 역할이 없는 보조인원입니다|
|바트|음식물 쓰레기, 즉 짬통을 비우는 역할을 합니다|
|쓰레기|꿀입니다. 그때그때 나오는 빵봉지나 요거트 용기 등을 담는 역할로, 쓰레기 봉투를 들고 가만히 있으면 됩니다.
...
- 세척 끝나고 훈육지도관에게 아침식사에 같이 나온 아이스크림 짬처리 당함. 어떻게 처리해야 하는지 고민하다가 냉동보관 하려고 분대장들 찾아가 검은색 냉동고 써도 되냐고 물어봤는데, 분대장이 누가 줬냐고 물어봄. 계급과 인상착의를 말하니까 분대장 3명이 동시에 "아 씨-발 그 장애인년" 이랬다고. 분대장들 찾아간 생활관 동기는 "어...음..어..."하다가 돌아옴. 아이스크림은 분대장들 통해 폐기됨.
- 타 중대 분대장 중에 수저랑 컵 씻고 있는 곳에 국 붓고 가는 양아치들도 있었음
- 점심시간 세척 전에 파란색 매트 안 접고 갔다고 벌점 받음
...
세척조를 진행했습니다. 세척조는 세척준비만을 위해 아침점호부터 인원보고만 참여하고 뜀걸음 단계부터는 열외되어 하러 세척을 하러 갑니다. 배식과 관련해 설거지와 뒷마무리를 담당하게 되는데, 구체적으로는 국식판, 굿그릇, 멀티, 바트, 쓰레기의 포지션으로 나누어서 진행하게 됩니다. 포지션은 제 생활관의 경우 사전에 뽑기로 정했고, 각 포지션별 역할은 다음과 같습니다.

- 식판: 식판을 설거지합니다.
- 국그릇: 국그릇을 설거지합니다.
- 멀티: 특별한 역할이 없는 보조인원입니다. 곳곳에서 여기 도움이 필요하다고 할 때 가서 식판을 같이 닦아주거나, 옮겨주거나 하는 역할입니다.
- 바트: 음식물쓰레기, 즉 짬통을 비우는 역할을 합니다.
- 쓰레기: 제일 편한 역할입니다. 그때그때 나오는 빵봉지나 요거트 용기 등을 담는 역할로, 쓰레기 봉투를 들고 가만히 있으면 됩니다.

마무리 청소가 굉장히 힘들고, 한 번 한 번 세척조를 진행할 때마다 옷에서 짬내가 납니다. 세척조는 한 번 차출되면 그날은 세척만 하다가 끝난다고 봐도 될 정도로 고됩니다.

이 날부터 저를 포함한 많은 인원이 감기에 걸렸습니다. 일어나자마자 목이 붓고 정신이 좀 몽롱한 정도의 증상이 있었는데, 나중에 알게 된 사실로 논산병이라 불리는 훈련소 특유의 감기라고 합니다. 이 감기는 훈련소를 수료하는 순간까지 완전히 낫지 않았습니다.

당시 메모 원본
: - 일요일인데 제대로 쉬지도 못함. 다만 평일에 훈련받고 세척하는 것보다는 낫다는 것을 위안삼음
...
휴식시간에 일어난 일을 하나 더 작성을 해두고 싶은데, 같은 훈련소 동기가 아마도 긴 이동거리 때문에 그랬던 것 같은데, 화생방 교장을 다녀오고나서부터 오른쪽 발목에 염증이 생겨 제대로 걷지 못하는 상태가 되었습니다. 밥먹으러 가기도 힘들어해서 전우조를 따로 정해서 업어서 이동했습니다.  
문제는, 생활관 인원중 한 명이 분대장을 찾아 "응급실이든 뭐든 보내야 하는 것 같다"라고 당사자 대신 보고하자 "사정은 알겠는데 우리가 할 수 있는게 제한되어 있다. 응급실은 너네가 생각하는 그런게 아니다."라는 답변을 받았고, 답답해서 소대장한테 한번 더 보고했더니 분대장 둘을 데리고 생활관으로 찾아왔습니다.  
소대장은 이 훈련병에게 한 번 일어서보도록 하고, 제대로 못 일어나자 현재 증상과 이전에 비슷한 병이 있었는지 등을 확인하고는 휴대폰으로 어딘가에 전화를 걸더니 본인 계급과 이름을 대고 지구병원을 예약함과 동시에 분대장을 시켜 임시로 목발을 받아왔습니다. 더 필요한 조치 있냐고 물어보고 없다고 하자 생활관을 나서는데 동기들이 말없이 박수를 쳤던 것이 기억납니다.
...
{% comment %}
우리도 "분대장님께 먼저 말씀드렸는데 전달이 잘 안 된다. 저희가 봐도 심한 것 같아서 소대장님께 말씀드렸다." 이렇게 말함.
{% endcomment %}
...
수류탄 훈련이 끝나고 교육대에 도착했는데, 중대장이 1중대 인원을 연병장으로 따로 빼내서 "내가 뒤에서 계속 보고 있었는데, 군기, 제식 완전 개판이야. 장난해? 놀러왔어?"라는 식으로 주의가 있었습니다. 저는 상황이 이해가 가서 불만없이 듣고 있었는데, 중대장이 마지막을 "여러분 화내서 미안하고~"라는 식으로 김 빠지게 끝냈습니다. 생활관 인원 전부 이게 군대인가 의아해하는 순간이었습니다.
...
당시 메모 원본
: - 치통 호소하던 훈련소 동기는 이 날 지구병원 가서 신경치료 받았음
...
이 날은 불침번도 없엇고 잠을 푹 자긴 했는데, 여전히 피곤함이 계속되었습니다.

3km 뜀걸음 측정이 있었는데, 측정 시작 전에 뜀걸음을 열외하고 체력단련을 대신 받을 사람을 따로 지원받았습니다. 저는 전 1.5km 뜀걸음 측정때 너무 힘들었어서 처음부터 열외했는데, 체력단련은 국군도수체조로 간단히 대체됐습니다.

각개전투는 낮은포복, 높은포복 등 신체적인 부담이 주어지는 자세가 꽤 있었고, 훈련이 있고나서 서있을 때 잠깐 어지러움이 올라오는 정도로 그동안의 훈련중 강도가 가장 높았습니다. 분대장의 시범을 먼저 보여준 후 훈련병들을 오와 열로 맞춰 정렬시켰고 "각개 힘든거 사회에서 안 배웠어? 밀어! 당겨! 밀어! 당겨!"라는 식으로 밀어붙였습니다.

각개전투는 각 동작이 끝나면 10분정도 휴식을 거칩니다. 이때 두 가지가 기억에 나는데, 하나는 쉬는 중에 "야 난 다음주에 간다~ 뺑이쳐라~"라며 현역 훈련병을 도발하는 훈련병이 있었다는 것, 또 하나는 그 와중에 훈련소 풍경이 굉장히 평화롭고 예뻤다는 겁니다.
...
당시 메모 원본
: - 내 훈련소 기수에 어떤 축구선수가 있다고 하던데, 실제로 압도적인 1등으로 들어왔음
- 이 날 샤워는 찬물샤워였음
...
각개전투가 끝나면 훈련소에서의 마지막 오침 시간을 가졌습니다. 바로 다음에 행군이 예정되어 있어서 2시부터 6시까지 4시간동안 푹 잘 수 있었습니다. 실제로 피로가 많이 풀리게 됩니다. 뒤에는 저녁식사를 했고, 이때 밥먹고 나오는데 딱 해가 보기좋게 넘어가려 하고 있었던 것이 기억납니다. 구름에 진 그림자, 시야의 왼쪽과 오른쪽에서 대비되는 주황색과 보라색의 밀도 등 풍경이 정말 예뻤던 것이 기억납니다.
...
처음에 행군을 시작할 땐 북두칠성이 보인다며 나름 즐기며 시작했지만, 야밤에 다칠 위험이 있다며 분대장이 전방주시와 정숙을 통제했고, 1회차 중간 정도가 지나면 진짜 모두 아무말 없이 걷기만 했습니다. 진짜 아무말 없이 45분동안 걷기만 6번을 해야 했고, 제 경우에는 너무 재미가 없어져서 나중에는 외국어로 발걸음을 세며 시간을 보냈습니다.

4회차 행군이 끝나고는 휴식시간에 파워에이드와 피자빵, 육포를 지급받았습니다. 개인적으로는 입맛이 없어서 파워에이드 조금과 피자빵만 먹고 말았습니다.

5회차 행군이 끝나고 휴식시간에 잠깐 눈 붙이고 있었더니 옆에 있던 다른 생활관 분이 "사탕 줄까요? 잠 깨게."라더니 슈퍼사워 사탕을 하나 줬습니다. 쓰레기는 제가 챙기려고 하니까 "쓰레기는 주세요. 제가 버릴게요" 하고 가져갔습니다. 양아치상이었고, 사실 딱 그 훈련병이 문제아라던 소문이 있었지만, 어쨌든 그때 겪었던 친절이 기억에 남습니다.

저는 전날 차등제로 뺐지만, 완전 군장 하고 간 사람들 중에서는 2명정도 부상이 있었다고 합니다.  그중에는 졸려서 걷다가 배수로에 발이 빠진 사람이 있었다고 하며, 근처에 있던 생활관 동기 말로는 무슨 총 부러지는 소리가 났다고 합니다.
...
행군이 끝나고 이등병 분대장에게 "뜨거운 물 나오도록 내가 말해뒀으니까, 가서 편하게 하고 싶은 만큼 샤워하고 와라"라는 말을 듣고 목욕탕에 갔는데, 찬물이 나왔습니다. 전문연구요원이었던 같은 생활관 동기 중 한 명이 진심으로 말없이 화내는 모습을 볼 수 있었습니다.
...
11시에 기상해서, 일어나자마자 점심을 먹고 전날 내려놓은 조끼와 군장을 가져왔습니다. 생활관에 돌아와서는 전투조끼, 탄창, 방탄모, 수통을 세척하고, 수통 뚜껑, 탄창 5개분의 아랫면과 방독면에 묻은 흙을 닦아내고 검사를 받았습니다. 조끼, 방독면 파우치는 물에 적셔서 생활관 옆 바닥에 생활관별로 정리해서 말렸습니다. 이 조끼와 파우치는 저녁을 먹고 회수했습니다.

이 날은 특별한 일정이 없었어서, 적당히 놀고 청소하고 야간점호를 받고 무난히 마무리되었습니다.
...
당시 메모 원본
: - 군대에서는 매 끼마다 엄청난 양의 음식물 쓰레기가 나온다. 이날은 멀쩡한 콘푸로스트 3봉지를 그냥 폐기했음. (가져가지도 못하게 함)

훈련소에서 배식과 관련해서 각 생활관별로 세척조 또는 배식조를 한 번씩 담당하게 되는데, 생활관 수가 부족해서 각 생활관별로 한 명씩을 대표로 보내 당직책상 앞에서 가위바위보로 정합니다. 제 생활관은

#### **18일차**

간만에 여유로운 휴일이었습니다.

171번 훈련병이 빨래를 넣으려고 문을 여는 순간 관물대가 떨어졌습니다. 분대장에게 보고하니 다른 분대장이 드릴을 갖고 와서 고정하고 갔는데, 이때 분대장 말이 기억이 납니다. "야 내가 인간 드릴이야. 하... 나 이런거 왜이렇게 잘하지?"
...
제 왼쪽 침상을 쓰던 훈련병 머리가 길어져서 잘리니 마니 하고 있을 때 생활관 인원이 담합해서 한 명의 분대장을 데리고 이건 봐주면 안되냐고 생활관 밖에서 당사자 없이 갖가지 설득을 하고 다녔고, 나중에 "어 저정도는 괜찮아" 한 마디를 받아냈습니다. 
...
아침식사 후에는 장구류 수를 확인하고, 파스를 지급받아 침대 낙서를 지웠습니다. 침대에 낙서를 하는 인원이 있나 싶겠지만 제 생활관에도 몇 명 있었습니다. 그런데 옆 생활관에서 파스를 너무 뿌려대서 냄새가 심했고, 우리 생활관에서 "파스 그만 뿌리라고!!" 하고 소리쳤다가 옆 생활관 사람들과 싸울 뻔한 일이 있었습니다. 좋게좋게 끝나기는 했습니다.

남은 시간에도 일과가 많지는 않았고, 생활관별로 생활복 상의와 하의 한 벌씩 가져가서 단체로 세탁함

173번 훈련병 자리에서 관물대가 또 떨어졌습니다. 그런데 이번에는 드릴이 없다며 고쳐주진 않았고, 임시로 알아서 잘 사용해보라는 식으로 넘어갔습니다.
...
이 날 부식은 프링글스 스모크바비큐 맛과 몬스터 화이트 제로슈거였습니다. 몬스터의 경우에는 5일차에 받왔던 적이 있었는데 중복해서 한 번 더 나왔네요.

당시 메모 원본
: - 서로 명찰 바꾸고 놈
- 밤에 화장실 청소도구 갖다놓으려 갔다가, 문 닫힐까봐 개뛰어감
- 173번 훈련병이 부적 만들어 달았음
...
전날 마음의 편지는 소대장에 의해 묻혔습니다. 사실, 다른 마음의 편지도 조금씩 쌓여 있던데 소대장이 소대원을 강의실로 불러놓고는, "훈련이 끝나니까 서로 찌르고 있다. 이거 제대로 가면 한 6명은 퇴소당할 것 같다. 하지만 난 너희들에게 수료의 단맛을 보여주고 싶다. 너희들 모두 3주 고생했기 때문에 난 이걸 조용히 묻을거다. 문제 있는 애들은 따로 불러서 이야기할테니 내 결정에 토 달지 마라. 해산!"이라며 해산시켰고, 모였던 소대원은 각자 생활관으로 돌아갔습니다.

당시 메모 원본
: - 생활관 동기 한 명과 노력vs재능 이라는 주제로 떠듬
...
마지막이라고 '훈련병의 날'이라는, 레크레이션 시간이 있었습니다. 학교 축제와 비슷한 느낌이었는데, 26연대는 시설이 낙후화되어있다며 27연대 건물을 빌려 진행했습니다. 여담이지만, 이때 본 27연대 건물은 26연대에 비하면 차이가 꽤 났습니다. 26연대는 오랫동안 보수되어온, 반대로 말하면 낙후화되어있는 느낌이라면 27연대는 동네 학교 시설 정도로 신식이고 깨끗해 보였습니다.

강의실에 훈련병을 모이자 빠삐코 아이스크림이 나왔습니다. 훈련병의 날이 진행되면서는 훈련병들이 직접 군가에 맞춰 안무와 연극을 하거나, 중대장 훈련병 넷을 불러 장기자랑을 시키거나, 분대장이 노래를 부르거나 하는 식으로 흘러갔습니다. 중대장이 제로투를 추거나 할 때 훈련병들의 호응이 굉장히 좋았습니다.
중대장 훈련병들 제로투 추고, 분대장이 노래 부르고, 환호하고, 소리 지르고..

저녁 먹기 전, 4~5시쯤 소대장이 소대원을 강의실로 불렀습니다. 소대장은 소대원 앞에서 "군인의 연이 닿은 사이로서 마지막 인사를 하려고 불렀다."라며, 덕담과 썰을 몇 가지 풀어주셨습니다. 

훈련소에서 큰 사건(이름, 이름)이 연달아 터지면서 교육대장, 연대장 등이 관심이 많았다고 함.

이때 소대장 된 썰이나 결혼하게 된 썰 등을 (소대원들이 물어봐서) 풀어 주셨는데, 그중에 소대장 된 썰이 인상이 깊었습니다. 사실 본인은 어렸을 때 사고치고 다니는 양아치였는데, 20대가 되고 뭘 먹고 살아야 하나 고민하다가 입대를 하게 되었고, 군인이 되어보니 정해진 시간에 시키는 것만 하면 되는 생활이 마음에 들어서 바로 부사관으로 지원했다고 합니다.

마지막으로 소대장은 소대원 모두에게 한 번씩 악수를 했습니다. 제 차례가 되었을 때 잡았던 소대장 손 느낌이 강하게 기억에 나는데, 손바닥이 부드럽고 손가락이 거칠었지만 온기가 있는, 전형적인 어른의 손이었습니다.

그리고 저녁점호 전에 짐을 싸뒀습니다.

저녁점호 후에는 분대장들이 각 방으로 찾아와서 마찬가지로 몇 가지 썰을 풀고 갔다고 합니다. 간접화법인 이유는, 저는 피곤해서 먼저 잤기 때문입니다. 분대장이 생활관 방문한다고 해서 기다려봤다가 계속 안 와서 먼저 잤더니, 일어나보니 분대장이 차례대로 방문해서 이것저것 썰을 풀어줬다고 합니다.

- 밤에 분대장들이 각 방으로 찾아와서 이야기 나눔.
    - 원래 마지막날 밤은 다들 잠을 안 잔다고.

개인적으로는 솔직히 아쉽고 먹먹한 느낌이 있었습니다. 훈련, 교장, 생활관 다 싫었지만, 훈련받을 때 다같이 아자아자하는 생활관 사람들의 분위기가 좋았고, 훈련소의 분위기가 제때 밥 먹으면서 스마트폰 없이 얼굴을 마주하고 간간히 떠들 수 있는게 꽤 건강하게 느껴졌습니다.

당시 메모 원본
: - 수료 하루 전임. 일기 날짜 적는데 기분이 이상하다
...
제 생활관의 경우 서로 사이가 좋았고, 수료식 끝나면 열외자들이 대기하고 있던 곳에 모여서 사진 찍고 헤어지자고 해서 전에 말 맞춰뒀던 대로 사진을 여러장 찍고 마지막 인사 ("수고하셨습니다!! 고생했어~")를 나누고 헤어졌습니다.

그리고 바로 집으로 출발해 짐을 풀고, 각종 훈련소 물품을 정리하고 현재입니다.

당시 메모 원본
: - 쏘대장 확성기 개웃겼음
- 부모님을 향해 손 흔들라고 할 때, 고개를 돌리자마자 가족이 있었음. 처음 든 생각은 "아니 여기 훈련소에.. 부모님이 왜 있지??"
- 분대장 나이는 다들 04였음

## **수료 후 느낀점**

집에 발을 들이고 나서부터는 분위기가 너무 달라서 훈련소 생활이 조금 꿈같이 느껴지고 있습니다. 수료 당일 집에 도착해 동네 풍경을 가만히 보고 있거나 제 방의 제 물건들을 만지고 있다 보면 내가 정말 논산에서 3주를 보냈었나 하는 생각이 듭니다.
- 훈련소 동기와 슬슬 친해지고 서로 재밌는 얘기를 본격적으로 나누게 될때 쯤 수료를 하게 됩니다. 개인적으로 좀 아쉬웠어요.

몸무게가 늘었습니다. 훈련소에서 몸도 많이 움직이지만 밥도 많이 먹어서 이게 찔까 빠질까 궁금했는데 결과적으로는 5kg 가까이 찌면서, 중고학생 때부터 일정했던 관성을 깨고 인생에서 처음으로 이례적인 고점을 찍어봤습니다. 꿈에서 가끔 분대장이나 같은 생활관 동기가 나오는 것도 있습니다. 기분이 막 더럽고 그러진 않았던 것 같은데.

군대는 굉장히 건강한 조직임. 나는 도파민 치료를 비롯해 정신적으로 매우 건강해져서 나왔다. 온갖게 다 교정당하고 에너지 입출입이 일었던 것 같음. 솔직히 훈련만 없으면 더 있어도 되겠다 싶었음.
군대에는 정말 다양한 스펙트럼의 사람들이 모이기 때문에 바보도 많고 천재도 많습니다. 개인적으로는 중학교 졸업 이후 학교별로 헤어졌던 사람들이 각자의 길을 가다가 잠시 길이 겹쳐서 만났다는 생각이 들었음.
폰과 타자가 어색함.

분대장도 성격이 다양합니다. 짬찌부터 적당히 군생활 흘렀으면 싶은 사람, 편의점 알바생처럼 눈이 풀려있는 사람, 모든게 다 짜증나는 사람, 군생활 정말정말 성실히 잘 하는 사람, 모두가 보는 앞에선 힘들고 엄하게 대하지만 훈련 일과가 끝나는 순간 굉장히 친절해지는 사람, 표정부터 모든게 여유로운 말년 병장 등등 다양한 유형이 있습니다.
...
애들이 그립다. 그때의 생활이 그립다. 앞으로는 이 때의 활기와 젊음이 더 그리워질 것을 아니까 더 미워진다. 그때 그 특유의 분위기, 다들 착하고 좋았는데. 어리숙하면서도 즐거웠고, 재밌었어.
{% endcomment %}