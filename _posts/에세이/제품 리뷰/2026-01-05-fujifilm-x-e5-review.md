...
- AF가 확실히 답답합니다. 후지필름 카메라가 5세대까지 오면서 쓸만한 정도로 개선됐다는 평가가 많이 보이지만, 그 쓸만함이라는 것은 정말 오래 전부터 카메라를 사용해온 분들의 주관적인 평인 것으로 보입니다. 개인적으로는 보급형 스마트폰보다도 조금 부정확하다는 인상을 받았습니다.
{: .prompt-info }
