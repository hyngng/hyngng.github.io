...
last_modified_at: 2026-02-21 23:11:00 +0900
...
> **2026-02-21 업데이트됨!**  
- 몇 달 더 사용해보니 레트로한 디자인이 가장 큰 장점입니다. 단순이 예뻐서가 아닙니다. 작고 가벼운 단렌즈와의 조합에서는 스마트폰 급으로 이목을 끌지 않고, 그 덕에 길거리에서 카메라를 걸고 걸어다녀도 오해를 잘 사지 않습니다. 사진 촬영의 접근성이 좋아진다는 뜻입니다.
- 40.2MP의 고화소는 큰 도움이 되었습니다. 덕분에 2배 크롭, 즉 면적으로 1/4까지는 잘라내도 무리한다는 느낌이 없습니다. 12MP, 24MP 환경의 사진에서는 느끼지 못했던 자유로움입니다.
{: .prompt-info }
...
> **2026-02-21 업데이트됨!**  
- 몇 달 더 사용해보니 생각보다 DR이 많이 좁습니다. 풀프레임 카메라는 적어도 스마트폰에서 멀티프레임 합성을 통해 구현된 HDR 사진과 비등한 수준이었습니다. 하지만 X-E5는 후지필름이라서인지 APS-C라서인지 스마트폰 RAW 파일에서나 보이던 정도의 좁은 DR을 보여줍니다.
...
이 렌즈는 단점과 장점이 뚜렷합니다. 장점은 장점 나름이지만 단점도 장점 못지않다는 것이 문제입니다. 빌드퀄리티, 조작감, 해상력과 같은 기본기가 탄탄하지만 감성으로 치부하기에는 AF가 발목을 잡습니다. 초점을 맞출 때마다 렌즈 외부가 물리적으로 움직이고 큰 기계적 소음이 발생합니다. 그 정도가 너무 심해서 영상용으로는 특히 활용이 불가능합니다. 2025년의 렌즈라고는 믿을 수 없습니다.
...
한편, 4달간 사용해본 결과 어느 정도의 감이 서고 있습니다. 결론적으로 중립과 실망 사이 그 어딘가입니다. 사용 경험을 요약하면 '분명 기본은 갖춰져 있는데 어딘가 좀 물렁한 카메라' 정도입니다. 크기와 무게, 감성 면에서 소니 A7C를 대체할 수는 있지만 화질과 신뢰성 면에서 생각보다 많이 부족하다는 것이 결론입니다. 2020년과 2025년 카메라의 비교이므로 최근의 풀프레임 카메라와 비교하면 격차가 꽤 크지 않을까 싶습니다.
