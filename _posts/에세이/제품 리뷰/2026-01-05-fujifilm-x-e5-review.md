...
last_modified_at: 2026-02-20 09:14:00 +0900
...
X-E5에 사용할만한 렌즈는 꽤 후하게 찾아봐도 찾아보기 어렵습니다. 티티아티산 27mm F2.8이 그렇게 좋은 물건이 아닌데 모두 이 렌즈를 사용하는 이유를 알 수 있을 정도입니다. X-E5에 잘 어울리는 것으로 찾아보면 거의 없다고 봐도 될 정도입니다. 그나마 이전에 소니를 사용할 때 자주 참고했던 SonyAlphaBlog의 [Which Lenses are best for A6xxx – Part 1 : Introduction & Summary](https://sonyalpha.blog/2020/03/02/which-lenses-are-the-sharpest-for-a-a6xxx/)를 최대한 이용했고, 네이티브 렌즈에 대해서도 MTF차트와 각종 리뷰로 최대한 열심히 찾아보았는데 그나마 다음 정도가 눈에 띕니다.
...
![Group 543](/2026-01-05-fujifilm-x-e5-review/Group 543.png)
*창경궁, 창덕궁과 국립민속박물관. 날 것 그대로의 스냅 사진들*

> 2026-02-21 수정됨!
{: .prompt-info }

약 4달간 사용해봤습니다. 결론적으로 중립과 실망 사이 그 어딘가입니다. 사용 경험을 요약하면 '분명 기본은 갖춰져 있는데 어딘가 좀 물렁한 카메라' 정도입니다. 소니 A7C를 대체할 용도로는 걸맞지 않습니다. 단순히 APS-C 카메라라서가 아니라 전반적으로 신뢰성이 좀 낮다는 것이 문제입니다.

### **실제로 체감되는 장점**

개인적으로 느끼기에는 레트로한 디자인이 가장 큰 장점입니다. 단순이 예뻐서가 아닙니다. 길거리에서 카메라를 걸고 지나다녀도 큰 오해를 사지 않을 수 있습니다. 카메라 자체가 상업용이 아닙니다.

40.2MP는 높은 화소입니다. 덕분에 좋은 것은 2배 크롭, 즉 면적으로 1/4까지는 잘라내도 보기에 자연스럽다는 겁니다. 12MP, 24MP 환경의 사진에서는 느끼지 못했던 자유로움입니다.

### **실제로 체감되는 단점**

그리고 DR이 많이 좁다는 것이 제가 생각하는 가장 큰 단점입니다. 정말 좁습니다. 

AF는 굼뜨고 답답합니다. 후지필름 카메라가 5세대까지 오면서 쓸만한 정도로 개선됐다는 평가가 많던데, 그 쓸만함이라는 것은 정말 오래 전부터 카메라를 사용해온 분들의 주관적인 평인 것으로 보입니다. 개인적으로는 보급형 스마트폰보다도 느리고 부정확하다는 인상을 받았습니다.

알루미늄을 깎아 만든 바디는 겉보기에는 멋있으나 단단한 느낌은 부족합니다. 마그네슘 합금 소재에 비하면 종잇장 같은 느낌입니다.

40.2MP의 고화소의 용량은 부담스럽다는 점만 마지막으로 특기하고 싶습니다.

### **XF 23mm F2.8 R WR**

실망감에 가장 큰 기여를 한 부분입니다. 이 렌즈는 단점과 장점이 뚜렷합니다. 장점은 장점 나름이지만 단점도 장점 못지않다는 것이 문제입니다.

이 렌즈는 빌드퀄리티, 조작감, 해상력과 같은 기본기가 탄탄합니다. 그러나 감성으로 치부하기에는 모터 소음이 시끄럽다는 것이 가장 큰 문제입니다. 초점을 맞출 때마다 렌즈 외부가 물리적으로 움직이고 큰 기계적 소음이 발생합니다. 그 정도가 너무 심해서 영상용으로는 특히 활용이 불가능합니다. 2025년의 렌즈라고는 믿을 수 없습니다.

아무래도 비교군이 타사 렌즈일 수밖에 없습니다. 소니 E마운트에서 비슷한 역할을 맡는 단렌즈, SEL35F28Z나 G 트리오의 경우에는 완성도가 높은 기계라는 느낌이 강합니다. 해상력도 좋고, 모터 소음도 없고, 조작감이나 빌드퀄리티가 기준점을 충분히 만족시킵니다.
...
사진의 간절함을 채워주기에는 충분합니다. 하지만 어설픕니다. 딱 애매한 선까지만 어설픕니다.
