...
> **2026-02-21 업데이트됨!**  
- 몇 달 더 사용해보니 생각보다 DR이 꽤 좁습니다. 풀프레임 카메라는 적어도 스마트폰에서 멀티프레임 합성을 통해 구현된 HDR 사진과 비등한 수준이었습니다. 하지만 X-E5는 후지필름이라서인지 APS-C라서인지 스마트폰 RAW 파일의 기시감이 드는 좁은 DR을 보여줍니다. 단, 큰 문제가 될 정도인지는 더 사용해봐야 알 것 같습니다.
