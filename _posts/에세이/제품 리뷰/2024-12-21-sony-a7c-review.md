...
사진을 스마트폰으로 찍다 보니 한계를 느끼고 있습니다. 가장 크게 느껴지는 것은 화각이 고정되어 있다는 것, 그리고 디테일과 다이나믹 레인지가 부족하다는 겁니다. 현재 사용중인 S22 울트라는 스마트폰 중에서도 카메라가 강점인 모델로 4개 카메라에 무려 1억 8백만 화소를 자랑하기는 하지만 스마트폰 폼팩터상의 한계로 다음과 같은 한계가 있습니다.
...
_A7C로 찍은 샘플 이미지. 비슷한 시기에 지인은 니콘 ZFC를 샀다._
...
: - 다이나믹 레인지가 매우 넓고, 보정관용도가 훌륭합니다. 얼핏 보면 스마트폰의 12MP에 비해 겨우 두 배 면적인 2420만화소는, 사실 좋은 렌즈를 사용한다면 두 배 이상의 디테일 향상을 보여줍니다. 보다 정확히는, 주어진 화소를 끝까지 사용한다는 느낌을 받을 수 있습니다.
