...
그래서 고전에 대한 기대감 딱 하나만으로 첫 페이지를 폈는데 아주 만족스럽게 읽었습니다. 의외로 재미가 있었습니다. 명상록이 저술된 시기는 고대 그리스의 이성적 유산이 로마 제국에 깊이 뿌리내린 170년경으로 스토아적 성찰이 이 책을 관통하는 핵심입니다. 그리고 그 내용은 현대인이 스스로 발상하기 어려운 개념으로 구성되어있고, 신선했습니다. 책을 읽으면서 애매모호하다고 느껴지는 부분, 비판적으로 볼 여지가 있는 부분이 없는 것은 아니었지만 기본적으로 제 마음을 맡기고 읽을 수 있었습니다.
