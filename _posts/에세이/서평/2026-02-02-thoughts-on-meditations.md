...
책 제목은 '자기 자신에게 이르는 것들'이지만 널리 명상록(Meditations)으로 알려져 있기에 명상록으로 통일합니다. 사실 원문이 작성된 시점이 너무 오래되었기 때문에 명상록이라는 브랜드 자체에 경계심이 있었습니다. 먼저 오랜 창작물의 제작 기법이나 소재 자체가 낡아보이듯이 오래된 철학도 현대적 감성과 괴리감이 있을 것이라는 걱정이 있었고, 다음으로 로마 황제가 저술했다는 상징성으로 과대평가되었다는 비판이나, 일관성이 부족하다는 버트런드 러셀의 지적 등으로 인해 부정적인 선입견도 있었습니다.
