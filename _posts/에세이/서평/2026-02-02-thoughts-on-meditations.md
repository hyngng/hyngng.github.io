...
last_modified_at: 2026-05-05 09:56:00 +0900
---
...
그러나 이런 부분은 비판적으로 보일 수밖에 없습니다. 앞에서는 타인의 영혼 속으로 들어가 이해하라고 했으면서, 여기서는 타인을 병자에 비유하고 '가르치거나 견뎌라'로 마무리하는 것은 태도가 다릅니다. 공동체적 의무를 설파한다는 점에서 분명 포용을 말하는 문장이기는 합니다. 그러나 황달에 걸린 사람과 광견병에 걸린 사람을 현실 상황에 대한 비유로 사용하고자 한다면 타인이 나와 다른 의견을 갖는다는 사실만으로 그들을 황달이나 광견병에 걸린 사람으로 치부해버릴 위험이 있습니다. 세상에 분명 그런 일이 일어나기는 하지만, 사람에 따라서는 극단적으로 받아들일 수도 있을 것 같습니다. 말의 요지는 황달, 광견병에 걸린 사람을 향해 화를 낼 필요는 없다는 것에 있기는 하나, 이해하려는 태도와 견디려는 태도에는 차이가 있습니다.
