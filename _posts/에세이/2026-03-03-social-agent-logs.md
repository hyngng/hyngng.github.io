...
last_modified_at: 2026-01-28 00:00:00 +0900
...
실제로 사회복무요원이 어떻게 되는지 먼저 설명할 필요가 있을 것 같습니다. 11월 중반의 수능 철, 사회복무요원 신청도 재학생에 한해 [병무청 병무민원 사이트에서](https://mwpt.mma.go.kr/caisBMHS/) 약 일주일간 같이 이루어집니다. 기관이 병무청에 인원 충원을 희망한 건에 대해 사회복무 대상자는 소집을 최대 2개 기관까지 순차적으로 지원할 수 있습니다. 만약 정원보다 지원자가 많을 경우 무작위 추첨을 통해 선발하되, 1년에 한 번뿐인 기회인 만큼 탈락 횟수에 따라 우선순위를 차등 부여합니다.

저는 학기 도중의 11월 20일, 예전에 휴대폰 캘린더 앱에 남겨뒀던 "사회복무요원 신청" 메모를 보고 기숙사에서 부랴부랴 알아보던 것이 생각납니다. 제가 지원한 곳은 인천교통공사였고, 최종적으로 다음과 같이 마감되었습니다.
...
친구와 카페에 있는데 병무청에서 카톡이 왔습니다. 괜찮은 시간을 보내다가 표정이 점점 굳어졌습니다.

지금도 병무청에서 알림이 올 때마다 조금씩 놀랍니다.
...
찾아갔을 때의 당혹스러움이 기억납니다. 사무실은 수영장 건물에 딸려 있었고, 문을 열고 들어가자 사무실은 어설프게 정리되어 있었고, 사회복무요원

훈련소 수료 직후였기 때문에, 자신을 사회복무요원이라고 소개하는 사람들 머리가 하나같이 긴 것이 어색하게 느껴졌던 것이 기업니다. 도착해서는 간단한 소개를 들었고, 별다른 업무 없이 근무가 끝나고 집에 도착했습니다.

## **무슨 일을 했는가**

솔직히 좋은 소리는 못 하겠습니다. 사실, 교통복지팀은 사내에서도 기피부서로 취급되는 분위기였던 것 같습니다.

### **전화 응대**

> "감사합니다 교통복지팀 사회복무요원 ○○○입니다" "용무가 어떻게 되실까요"
...
제 업무를 설명하기 위한 기본적인 구조는 이렇습니다. 대한민국에는 시각장애나 지적장애 등의 이유로 교통약자로 분류되는 분들이 계시고, 교통복지팀은 고객의 휠체어 이용 유무에 따라 일반 택시와 특수 장애인 차량(이하 특장차) 두 가지 형태로 이동 서비스를 제공합니다. 전자는 바우처 택시, 후자는 특장차로 불립니다.

바우처 택시, 특수장애인이동차량(이하 특장차) 두 가지로 장애인 이동 서비스를 지원합니다. 기본적으로 큰 틀은 인천시에서 관리하고, 세부적인 것을 인천교통공사가 담당합니다.
...
행정 강도가 높은 측면에 속했습니다. 저는 여태껏 전화나 문자를 받는 위치에 있었는데, 20개월간 역으로 전화나 문자를 보내는 위치가 되면서 그들의 고역을 이해하게 되었습니다.

조직 목표 달성을 위해 자원을 관리하고 체계적으로 실행하는 과정이라고 한다면,

기본적으로 연락이 닿지 않는 경우가 있습니다. 연락이 닿아도 내용 이해가 어려운 경우가 있습니다. 이건 그들의 잘못이라기보다는 상황 자체가 나쁘기 때문에 가깝습니다.
...
그래서 마음에 안 드는 부분이 있었습니다. 모두가 그렇진 않았지만 사회복무요원 사이 우열을 나누는 분들이 계셨습니다. 권위는 직급이 아닌 이름에 있어야 한다고 생각합니다.
...
사무실에서 그림을 그릴 수 있는지 또는 책을 읽을 수 있는지를 분위기를 살펴봤지만 그럴만한 환경이 되지 않는다고 생각했습니다.
